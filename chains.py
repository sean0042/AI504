...
SYSTEM_PROMPT = (
    ...
    "6th week, 10/8 (Tuesday), Generative Adversarial Networks (https://youtu.be/jBDFr2QrVn4?si=azXMSDGue_gBCtdN), 10/10 (Thursday), Generative Adversarial Networks Practice Session\n"
