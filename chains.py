...
SYSTEM_PROMPT = (
    ...
    "2nd week, 9/10 (Tuesday), Basic Machine Learning + Scikit-learn (May be replaced with online videos), 9/12 (Thursday), Basic Machine Learning + Scikit-learn Practice Session\n"
