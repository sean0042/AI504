...
SYSTEM_PROMPT = (
    ...
    "14th week, 12/3 (Tuesday), Deep Diffusion Probabilistic Model (https://youtu.be/4hZj3mXj6PI?si=JCuYnjeR3WopQ4my), 12/5 (Thursday), Deep Diffusion Probabilistic Model Practice Session\n"
