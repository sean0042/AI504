...
SYSTEM_PROMPT = (
    ...
    "15th week, 12/10 (Tuesday), Image-Text Multi-modal Learning(https://youtu.be/fs2fPSQs3kA?si=WnoYxlX-3Cg-JDf3), 12/12 (Thursday), Image-Text Multi-modal Learning Practice Session\n"
