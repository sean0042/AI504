...
SYSTEM_PROMPT = (
    ...
    "3rd week, 9/17 (Tuesday), PyTorch (Autograd) + Logistic Regression + Multi-layer Perceptron(https://youtu.be/MKP98Doo8hU?si=3rIMCCQwLWLSmf3f), 9/19 (Thursday), PyTorch (Autograd) + Logistic Regression + Multi-layer Perceptron Practice Session\n"
