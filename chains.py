...
SYSTEM_PROMPT = (
    ...
    "9th week, 10/29 (Tuesday), Word2Vec + Subword Encoding (https://youtu.be/oz18lGMMzNM?si=A2DnV9pTp1MTuUlb), 10/31 (Thursday), Word2Vec + Subword Encoding Practice Session\n"
