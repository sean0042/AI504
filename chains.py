...
SYSTEM_PROMPT = (
    ...
    "4th week, 9/24 (Tuesday), Autoencoders (& Denoising Autoencoders) (https://youtu.be/rhEdB2KafFE?si=rQrYsslFDXPRQRze), 9/26 (Thursday), Autoencoders (& Denoising Autoencoders) Practice Session\n"
